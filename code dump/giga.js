...
var ToastOptions = /** @class */ (function () {
    ...
    ToastOptions.prototype.ToastOptions = function (text, icon) {
        this.text = text;
        this.icon = icon;
    };
    return ToastOptions;
...
var ToastConfig = /** @class */ (function () {
    ...
    ToastConfig.prototype.ToastConfig = function (position, timeOut) {
...
var ComponentBase = /** @class */ (function () {
    ...
    ComponentBase.prototype.ComponentBase = function () { };
...
var Toast = /** @class */ (function (_super) {
    ...
    Toast.prototype.Toast = function (toastClass, options) {
        //Empty constructor
